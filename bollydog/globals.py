...
hub = Proxy(lambda: _hub_ctx_stack.top, name='hub')
...
services = MutableMappingProxy(lambda: _services_ctx_stack.top, name='services')
registry = Proxy(lambda: _registry_ctx_stack.top, name='registry')
